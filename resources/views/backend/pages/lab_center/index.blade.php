        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">Patient</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li><span>All Lab Centers</span></li>
                    </ul>
                </div>
            </div>
                                    ...
                                    @foreach ($lab_centers as $data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (Auth::guard('admin')->user()->can('doctor.edit'))
                                                    <a class="btn" data-toggle="tooltip"
                                                        href="{{ route('admin.lab_centers.edit', $data->id) }}"><i
                                                            class="fa fa-pencil"></i></a>
                                                @endif

                                                <a class="btn btn-danger text-white"
                                                href="{{ route('admin.lab_centers.destroy', $data->id) }}"
                                            ...
                                            <form id="delete-form-{{ $data->id }}"
                                                action="{{ route('admin.lab_centers.destroy', $data->id) }}"
